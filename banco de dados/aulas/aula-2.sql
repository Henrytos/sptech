...
INSERT INTO Atleta VALUES(DEFAULT, 'Rafaela', 'Judo', 2);
INSERT INTO Atleta VALUES(DEFAULT, 'Bia', 'Judo', 2);
INSERT INTO Atleta VALUES(DEFAULT, 'Rebeca', 'Ginastica Artistica', 6);
INSERT INTO Atleta VALUES(DEFAULT, 'Flávia', 'Ginastica Artistica', 5);
INSERT INTO Atleta VALUES(DEFAULT, 'Marcus', 'Tiro com Arco', 0);
INSERT INTO Atleta VALUES(DEFAULT, 'Ana', 'Tiro com Arco', 2);
INSERT INTO Atleta VALUES(DEFAULT, 'Sandro', 'Natação', 2);
INSERT INTO Atleta VALUES(DEFAULT, 'Leo', 'Natação', 2);
...
UPDATE Atleta SET nome = 'Flávia vieira' WHERE idAtleta = 4;

# • Adicionar o campo dtNasc na tabela, com a data de nascimento dos atletas, tipo date;
ALTER TABLE Atleta ADD COLUMN dtNasc DATE;

# • Atualizar a data de nascimento de todos os atletas;
UPDATE Atleta SET dtNasc = '1990-08-21' WHERE idAtleta  = 1;
UPDATE Atleta SET dtNasc = '1990-07-12' WHERE idAtleta  = 2;
UPDATE Atleta SET dtNasc = '1990-06-03' WHERE idAtleta  = 3;
UPDATE Atleta SET dtNasc = '1990-05-24' WHERE idAtleta  = 4;
UPDATE Atleta SET dtNasc = '1990-04-25' WHERE idAtleta  = 5;
UPDATE Atleta SET dtNasc = '1990-03-16' WHERE idAtleta  = 6;
UPDATE Atleta SET dtNasc = '1990-02-07' WHERE idAtleta  = 7;
UPDATE Atleta SET dtNasc = '1990-01-28' WHERE idAtleta  = 8;
...
UPDATE Filme SET protagonista = CASE idFilme 
	WHEN 1 THEN 'ciclano'
  WHEN 2 THEN 'homen de ferro'
  WHEN 3 THEN 'pi'
  WHEN 4 THEN 'will smith'
  WHEN 5 THEN 'yuta'
  WHEN 6 THEN 'deutrano'
  END 
  WHERE idFilme IN(1,2,3,4,5,6)
...
# ‘assistente’ ou ‘titular’ criação singular;
